...
MASTER CLAUDE ships **no** unattended runner scripts: there is no "always-on" build loop, no headless batch
...
safety judgement always outrank any MASTER CLAUDE skill.
